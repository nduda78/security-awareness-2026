...
INSERT INTO "new_BadgeFlare" ("achievements", "backgroundColor", "backgroundEffect", "borderStyle", "codenameOverride", "employeeId", "expiresAt", "holoSheen", "iconOverride", "motto", "nameSuffix", "outlineColor", "ribbonText", "secretBackText", "updatedAt") SELECT "achievements", "backgroundColor", "backgroundEffect", "borderStyle", "codenameOverride", "employeeId", "expiresAt", "holoSheen", "iconOverride", "motto", "nameSuffix", "outlineColor", "ribbonText", "secretBackText", "updatedAt" FROM "BadgeFlare";
